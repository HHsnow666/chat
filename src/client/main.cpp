    ...
    else // 登录成功
    {
        ...
        if (responsejs.contains("offlinemsg"))
        {
            ...
            for (auto &str : vec)
            {
                ...
                {
                    cout << js["time"].get<string>() << " 群聊消息[ " << js["groupid"] << "]: "
                         << "[" << js["id"] << "] "
